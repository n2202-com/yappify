...
MOD_ROLE_ID = 1506204509481992232
GUILD_ID = 1504557877493370900  # put your server ID here
...
async def process_queue():
    while len(waiting_channels) >= 2:
        ...
        # DO NOTHING (or remove process_queue usage entirely for calls started via start_call)
        pass
